...
export const Categorystatus = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 122.88 111.96" style={{ enableBackground: 'new 0 0 122.88 111.96' }} xmlSpace="preserve">
    <g>
